...
from classroom.views import Categories, savedpq, CategoryCourses, NewCourse, Enroll, DeleteCourse, EditCourse, MyCourses, CourseDetail, CourseDetail2, Submissions, StudentSubmissions, GradeSubmission
...
urlpatterns = [
	...
	path('savedpq/', savedpq, name='savedpq'),
	...
	#path('<course_id>/', CourseDetail2, name='course'),
