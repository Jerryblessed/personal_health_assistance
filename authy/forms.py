...
def InvalidAge(value):
	if '@' in value or '+' in value or '-' in value:
		raise ValidationError('This is an Invalid Age, Do not user these chars: @ , - , + ')
...
class SignupForm(forms.ModelForm):
	...
	age = forms.CharField(widget=forms.NumberInput(attrs={ "id":"age","placeholder":"age"}), max_length=100, required=True,)
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['age'].validators.append(InvalidAge)
